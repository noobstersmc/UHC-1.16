...
public class GoToHell extends IGamemode implements Listener {
    ...
    public GoToHell(UHC instance) {
        super("Go to Hell", "Players that stay in the overworld will periodically recieve damage after a specified amount of time.");
    ...
    public class GoToHellCMD extends BaseCommand {
        ...
        @Default
        public void toggleDamge(CommandSender sender) {
            damage = !damage;
            sender.sendMessage("Damge has been swith to: " + damage);
